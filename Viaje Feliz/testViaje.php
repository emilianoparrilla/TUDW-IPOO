...
$objViaje = new Viaje('033#56fh', 'Buenos Aires', 17, $arregloViaje, $objResponsable);
...
while ($seleccion != 0){
    switch ($seleccion){
        ...
        case 5:
            ...
            echo "Nombre: ";
            $nombreMod = strtoupper(trim(fgets(STDIN)));
            echo "Apellido: ";
            $apellidoMod = strtoupper(trim(fgets(STDIN)));
            echo "DNI: ";
            $dniMod = trim(fgets(STDIN));
            echo "TELEFONO: ";
            $telefonoMod = trim(fgets(STDIN));
            $objPasajeroMod = new Pasajero($nombreMod,$apellidoMod,$dniMod,$telefonoMod);
            $valMod = $objViaje->ModificarPasajero($objPasajero, $objPasajeroMod);
            if ($valMod == true){
        ...
        case 6:
            ...
            echo "Nombre: ";
            $nombreEliminar = strtoupper(trim(fgets(STDIN)));
            echo "Apellido: ";
            $apellidoEliminar = strtoupper(trim(fgets(STDIN)));
            echo "DNI: ";
            $dniEliminar = trim(fgets(STDIN));
            echo "TELEFONO: ";
            $telefonoEliminar = trim(fgets(STDIN));
            $objPasajeroEliminar = new Pasajero($nombreEliminar,$apellidoEliminar,$dniEliminar,$telefonoEliminar);
            $valBorrar = $objViaje->borrarPasajero($objPasajeroEliminar);
            if ($valBorrar == true){
